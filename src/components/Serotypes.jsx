...
const Serortype = () => {
  ...
  const memoisedTableColumns = useMemo(() => [
    ...
    {
      header: <TextWithToolTip text="Positive in <a class='link' href='https://ssid.com/disease-areas/respiratory-diseases/s-pneumoniae-pneumococcus/pneumococcus-antisera/' target='_blank' rel='noreferrer'>SSI Antisera</a>" tooltipHTML='
