const content = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        {
          md: 'In 2020, the GPS project is marching into the next chapter, GPS2. The outputs of GPS highlight the needs on'
        },
        {
          md: '1. **Increasing geographical coverage** in countries, especially those with high disease burden, such as India, Nigeria, DRC Congo and Pakistan, together these four countries accounted for approximately 50% of global pneumococcal disease burden in 2015.'
        },
        {
          md: '2. **Supporting local data generation and analysis** to achieve a working system for long-term and sustainable genomic surveillance in LMICs by providing capacity building and [bioinformatics training](https://training.bactgen.sanger.ac.uk/).'
        },
        {
          md: '3. **Engaging with policy makers** to communicate the value of the data and the importance of study findings for decision-making in pneumococcal disease prevention.'
        },
        {
          md: 'The success of the GPS project has also opened up opportunities to establish strategic partnership with'
        },
        {
          md: '1. [SIREVA](https://redsirevanetwork.com/) to establish a framework for integrating whole-genome sequencing in the ongoing surveillance in Latin America.'
        },
        {
          md: "2. [Professor Moon Nahm's lab](https://www.vaccine.uab.edu/) at the University of Alabama to characterise capsule structure of the nine potential new serotypes."
        },
        {
          md: "3. [NHMRC Centre of Research Excellence for Pneumococcal Disease Control in the Asia-Pacific (CRE-PDC)](https://www.mcri.edu.au/research/strategic-collaborations/centres/centre-pneumococcal-disease-control-asia-pacific) at the Murdoch Children's Research Institute to understand the sustainability of national immunisation PCV programs in the Asia-Pacific region."
        },
        {
          md: ' Last but not least, we thank the [Bill & Melinda Gates Foundation](https://www.gatesfoundation.org/) to fund this project.'
        },
      ]
    },
    {
      ...
      content: [
        {
          md: '- [The Story of GPS](https://sangerinstitute.blog/2019/06/12/tracking-a-deadly-shapeshifter)'
        },
        {
          md: '- [GPS Headline Findings](https://www.sanger.ac.uk/news_item/pneumonia-mapped-largest-genomic-survey-any-disease-causing-bacterium/)'
        },
        {
          md: '- [VIEW-hub: Reports on disease burden, vaccine access and coverage](https://view-hub.org/)'
        },
        {
          md: '- [Gavi: the Vaccine Alliance](https://www.gavi.org/)'
        },
      ]
    },
  ]
