      ...
      content: [
        {
          ...
          content: [
            ...
            {
              title: 'Population genomics of pneumococcal carriage in South Africa following the introduction of the 13-valent pneumococcal conjugate vaccine (PCV13) immunization',
              platform: 'Microbial Genomics',
              buttons: [
                {
                  text: 'Journal',
            ...
            {
              title: 'A *Streptococcus pneumoniae* lineage usually associated with pneumococcal conjugate vaccine (PCV) serotypes is the most common cause of serotype 35B invasive disease in South Africa, following routine use of PCV',
              platform: 'Microbial Genomics',
              buttons: [
                {
                  text: 'Journal',
            ...
            {
              title: 'Genomic surveillance of invasive *Streptococcus pneumoniae* isolates in the period pre-PCV10 and post-PCV10 introduction in Brazil',
              platform: 'Microbial Genomics',
              buttons: [
                {
                  text: 'Journal',
            ...
            {
              title: '*Streptococcus pneumoniae* genomic datasets from an Indian population describing pre-vaccine evolutionary epidemiology using a whole genome sequencing approach',
              platform: 'Microbial Genomics',
              buttons: [
                {
                  text: 'Journal',
